...
import JobViewButton from './JobViewButton';
...
export default function JobList() {
  ...
  const { data: jobList } = useSuspenseQuery({
    queryKey: [
      'getJobListApi',
      namespace,
      filterBy,
  ...
  return (
    <>
      <Table.Root>
        ...
        <Table.Body>
          {jobList.resources.map((resource: Resource) => (
      ...
      <Pagination
        totalItemCount={jobList.listMeta.totalItems}
